...
class Command(NoArgsCommand):
    ...
    def handle_noargs(self, **options):
        ...
        for i in range(1,57):
            ...
            shpfile = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../../../../redistrictingdata/state_tabblock_shapefiles/tl_2010_'+padded_i+'_tabblock10/tl_2010_'+padded_i+'_tabblock10.shp'))

            print "Attempting import of shapefile "+shpfile

            try:
                lm = LayerMapping(CensusBlock, shpfile, censusblocks_mapping)
            except OGRException:
