...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for i in range(1,57):
            ...
            shpfile = os.path.abspath(os.path.join(os.path.dirname(__file__), datadir+'/state_tabblock_shapefiles/tl_2010_'+padded_i+'_tabblock10/tl_2010_'+padded_i+'_tabblock10.shp'))
